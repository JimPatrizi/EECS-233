...
public class NumArrayListTest {
	...
	public void testDefaultConstructorAndToString() {
		...
		assertEquals(
				"With no parameters, your constructors should initialize a list size 0. "
	...
	public void testUserDefinedConstructor() {
		...
		assertEquals(
				"A constructor that initalizes a list to defined user capacity.",
				2, l.capacity());
		assertEquals(
				"A constructor that initalizes a list to defined user capacity.",
				10000, l2.capacity());
	...
	public void testInsert() {
		...
		assertEquals(
				"The new array should read because we inserted 2.0 at the 1 index",
				"1.0 2.0 3.0", l.toString());
	}
